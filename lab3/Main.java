...
class heir_class extends base_class {
...
public class Main {
    public static void main(String[] args) {
        ...
        int n = in.nextInt();
        base_class class1 = new base_class(n);
        System.out.println(class1.process());
        heir_class class2 = new heir_class(n);
        for (String i : class2.print_f()){
